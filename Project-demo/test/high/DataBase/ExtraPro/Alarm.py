...
extracted_time = open('C:\\Users\\Deep\\PycharmProjects\\PyProject\\high\\Data.txt','rt')
time = extracted_time.read()
Time = str(time)

delete_time = open("C:\\Users\\Deep\\PycharmProjects\\PyProject\\high\\Data.txt",'r+')
...
def RingerNow(time):
    ...
    while True:
        ...
        if current_time == Alarm_Time:
            ...
            playsound("C:\\Users\\Deep\\PycharmProjects\\PyProject\\high\\DataBase\\Sounds\\1.mp3")
